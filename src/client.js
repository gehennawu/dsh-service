...
`
    ...
    const zh = {
      ...
      'overview.resetCardExpiring': '重置卡今日到期：{cards}',
      ...
      'quota.navToggleHint': '开启后在设置页左侧标签列底部显示「额度查询」快捷入口',
    ...
    const en = {
      ...
      'overview.resetCardExpiring': 'Reset card expires today: {cards}',
      ...
      'quota.navToggleHint': 'When enabled, a "Quota lookup" entry appears at the bottom of the settings left navigation',
