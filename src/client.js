...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const zh = {
      ...
      'quota.window.claude-5h': 'Claude 5 小时窗',
      'quota.window.claude-week': 'Claude 本周窗',
    ...
    const en = {
      ...
      'quota.window.claude-5h': 'Claude 5-hour window',
      'quota.window.claude-week': 'Claude weekly window',
