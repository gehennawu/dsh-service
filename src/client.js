...
`
    ...
    const zh = {
      ...
      'plugin.compat.impact.settings-scope': '静态依赖或直接绑定 settingsScope 的客户端半在新版宿主激活挂起，面板整体不可用',
      ...
      'plugin.compat.break.settings-scope': '依赖已移除的客户端设置服务 settingsScope（0.1.7-alpha.1 起官方配置面改由 configForms 提供，静态依赖该服务的客户端半在新版宿主无法激活）',
    ...
    const en = {
      ...
      'plugin.compat.impact.settings-scope': 'A client half that statically injects or directly binds settingsScope keeps the whole client activation pending on new hosts',
      ...
      'plugin.compat.break.settings-scope': 'Depends on the removed client settings service settingsScope (the official config surface moved to configForms in 0.1.7-alpha.1; client halves statically depending on that service fail to activate on new hosts)',
