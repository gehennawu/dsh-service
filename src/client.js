...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const zh = {
      ...
      'quota.window.gemini-5h': 'Gemini 5 小时窗',
      'quota.window.gemini-week': 'Gemini 本周窗',
      'quota.window.claude-5h': 'Claude / GPT 5 小时窗',
      'quota.window.claude-week': 'Claude / GPT 本周窗',
    ...
    const en = {
      ...
      'quota.window.gemini-5h': 'Gemini 5-hour window',
      'quota.window.gemini-week': 'Gemini weekly window',
      'quota.window.claude-5h': 'Claude / GPT 5-hour window',
      'quota.window.claude-week': 'Claude / GPT weekly window',
