...
test('service panel puts versions first and renders switchable provider-prefixed usage charts by project', async () => {
  ...
  assert.match(overviewText, /报错信息.*最近 48 小时.*模型报错.*2 类.*工具报错.*2 类/)
  ...
  assert.match(expandedText, /最近 48 小时.*RATE_LIMIT.*429.*4 次.*AUTH.*401.*2 次/)
...
test('version card carries no DSH adaptation notice on any running version, two rows on narrow containers', async () => {
  ...
  try {
    const versions = ['0.1.2-rc.1', '0.1.5-rc.2', '0.1.6-alpha.2', '0.1.6-alpha.3', '0.1.6', '0.1.7-alpha.2', '0.1.7-alpha.3', '0.1.7-rc.1', '0.1.7-rc.2', '0.1.7-rc.3', '0.2.0', 'unknown']
