...
- **Five-tab service control**: Settings is split into Overview, Health diagnostics, Model statistics, Backup maintenance, and Restart line-style tabs. It uses a DSH-native-like underline selection and one content layer instead of nested background cards. Overview contains only versions, update controls, and existing container runtime metrics; deep diagnostics and file-permission inspection/repair live in the separate Health diagnostics tab.
