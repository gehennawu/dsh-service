...
- The session header (title / "N subagents" count / preset chip) no longer crushes together on phones: the header's right padding and button-cluster gaps are tightened, the count chip is pinned unclippable, and the official crumbs **hard-clip** is replaced by the title's ellipsis absorbing all the slack — title, count, and preset chip all stay fully visible from 320 px to 1023 px (no more "1 subage…" style cuts), desktops unchanged
