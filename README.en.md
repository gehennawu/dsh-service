...
[![Version](https://img.shields.io/badge/version-1.6.0-3b82f6.svg?style=flat-square)](package.json)
...
- Scroll immersion: inside a conversation, swiping down auto-hides the header and composer for full-screen reading; swipe up, reaching the bottom, or focusing the composer brings them back (no extra floating button). Programmatic scrolling (streaming pinning, anchor jumps) never triggers it
